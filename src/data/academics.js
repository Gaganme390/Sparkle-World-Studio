export const academicWings = [
  ...
  },
  {
    id: 'primary',
    title: 'PRIMARY WING',
    subtitle: 'Conceptual Depth & Expressive Literacy',
  ...
  },
  {
    id: 'middle',
    title: 'MIDDLE WING',
    subtitle: 'Critical Analysis & Collaborative Inquiry',
  ...
  },
  {
    id: 'senior',
    title: 'SENIOR WING',
    subtitle: 'Academic Mastery & Global Preparedness',
    grades: 'Grades IX to XII',
    ageGroup: '14 – 18 Years',
    description: 'Empowering future leaders for competitive entrance examinations and global university pathways through rigorous discipline, mentorship, specialized academic streams, and research depth.',
    keyFeatures: [
      'Science, Commerce & Humanities specialized streams',
      'Competitive exam prep (JEE, NEET, CUET, SAT guidance)',
...
export const academicPillars = [
  {
    number: '01',
    title: 'Curiosity-Driven Pedagogy',
    desc: 'Learning begins with asking meaningful questions. Our curriculum encourages students to probe deeper, challenge assumptions, and discover solutions independently.'
  },
  {
    number: '02',
    title: 'Tech-Enabled Smart Classrooms',
    desc: 'Every instructional space is equipped with interactive digital boards, immersive visual learning suites, and seamless connectivity.'
  },
  {
    number: '03',
    title: 'Holistic Assessment Model',
    desc: 'Moving beyond rote memorization. Evaluation focuses on conceptual comprehension, portfolio research, group presentations, and practical application.'
  },
  {
    number: '04',
    title: 'Individualized Learning Pathways',
    desc: 'Small student-teacher ratios ensure every child receives tailored mentorship aligned with their unique aptitude, learning style, and goals.'
  }
];
